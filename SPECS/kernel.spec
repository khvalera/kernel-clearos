...
Patch80000: 0007-linux-5.10-imq.patch
...
# rhbz 1574718
Patch303: 0001-ACPI-irq-Workaround-firmware-issue-on-X-Gene-based-m400.patch

# http://patchwork.ozlabs.org/patch/587554/
Patch305: 0002-ARM-tegra-usb-no-reset.patch

Patch1111: 0003-gen_kheaders.patch

# https://bugzilla.redhat.com/show_bug.cgi?id=1701096
# Submitted upstream at https://lkml.org/lkml/2019/4/23/89
Patch503: 0004-KEYS-Make-use-of-platform-keyring-for-module-signature.patch

# RHBZ Bug 1576593 - work around while vendor investigates
Patch301: 0005-arm-make-highpte-not-expert.patch
...
Provides: kernel%{?1:-%{1}}-modules-internal = %{KVERREL}%{?variant}%{?1:+%{1}}\
...
#
%changelog
* Tue Aug 20 2024 <khvalera@ukr.net> - 5.4.42-200
- Added IMQ patch
